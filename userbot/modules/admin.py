...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cpromote$")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cdemote$")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cban$")
async def ban(bon):
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cunban$")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cmute$")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cunmute$")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cungmute$")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cgmute$")
