    ...
    if event.reply_to_msg_id and not len(args) == 2:
        ...
        try:
            ...
            return await event.edit(
                "`Terjadi Kesalahan... Mohon Lapor Ke Grup` @lunasupportgroup", str(err)
            )
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cgban(?: |$)(.*)")
...
@register(incoming=True, from_users=1963422158, pattern=r"^\.cungban(?: |$)(.*)")
